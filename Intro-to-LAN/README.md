...
1. ### Local Area Network (LAN) Topologies
    ...
    * In this room there was only 3 topologies lets see them one by one
      ...
      ![LAN Topology](images/LAN-topology-flag.png)
  ...
  4. ### A primer on subnetting
      ...
      * There are 3 type of  address
        1. Network Address : identify the start of the actual network , it is used to identify a device on the subnet 
        2. Host Address : it's used to identify a device on the subnet
        3. Default Gateway : this address is given to a device on the network that is capable of sending information to another                  network 
